...
FR_PWM = pwmio.PWMOut(board.GP7, duty_cycle = int(2**13.5), frequency = 500)
...
BL_PWM = pwmio.PWMOut(board.GP19, duty_cycle = int(2**13.5), frequency = 500)
...
BR_PWM = pwmio.PWMOut(board.GP22, duty_cycle = int(2**13.5), frequency = 500)
