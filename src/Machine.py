...
class Machine():
    ...
    def Move(self, direction_platform, distance, speed):
        ...
        if direction_platform == 90:
            self.front_left.Move(False, distance, speed, 165)
            self.front_right.Move(True, distance, speed, 150)
            self.back_left.Move(True, distance, speed, 150)
            self.back_right.Move(False, distance, speed, 150)
        ...
        if direction_platform == 180:
            self.front_left.Move(False, distance, speed, 165)
            self.front_right.Move(False, distance, speed, 150)
            self.back_left.Move(False, distance, speed, 150)
            self.back_right.Move(False, distance, speed, 150)
